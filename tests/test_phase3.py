...
def test_migration_upgrade_from_empty_database(tmp_path):
    ...
    with app.app_context():
        ...
        assert {"transaction", "income_schedule", "planned_commitment", "one_off_forecast_event", "sinking_fund_provision", "household_forecast_setting", "variable_budget", "payment_reconciliation"} <= tables
